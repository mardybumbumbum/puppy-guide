...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-stone-200 h-16 md:hidden">
            ...
            <li key={item.href} className="flex-1">
              <Link
                ...
                className={`flex flex-col items-center justify-center gap-1 h-full w-full transition-colors ${
                  isActive ? item.activeColor : 'text-stone-400'
                }`}
              >
                {item.icon(isActive)}
